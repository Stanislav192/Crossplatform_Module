...
namespace Cross_Module1
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            try
            {
                string inputFile = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Cross_Module1", "INPUT.txt").Trim();
                ...
                File.WriteAllText(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Cross_Module1", "OUTPUT.txt"), result.ToString().Trim());
